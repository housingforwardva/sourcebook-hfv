...
ui <- page_fillable(
  ...
  div(
    ...
    div(
      ...
      h4("Cost Burden by Income Level (AMI)", class = "title-text")
    ),
      ...
      div(
        ...
        navset_tab(
          ...
          nav_panel(
            ...
            value = "state",
            padding = 5,
            # MOBILE OPTIMIZATION #7: Direct plot output
...
server <- function(input, output, session) {
  ...
  output$state_plot <- renderGirafe({
    create_interactive_plot(create_plot(filtered_state(), "Virginia Cost Burden by Income Level"))
  })
